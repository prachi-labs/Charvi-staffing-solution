    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-[#D9A441]/30 backdrop-blur-sm shadow-sm">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm">
        ...
        <div className="mt-14 relative max-w-5xl mx-auto">
          ...
          <div className="absolute -top-5 -left-2 sm:-top-6 sm:-left-6 bg-[#071A2B]/90 backdrop-blur-md border border-white/15 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-xl shadow-black/50 z-20 flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#D9A441]/15 border border-[#D9A441]/30 flex items-center justify-center text-[#D9A441]">
              <Award className="w-5 h-5" />
            </div>

            <div>
              <div className="text-lg sm:text-2xl font-extrabold text-white leading-none">
                25+ Years
              </div>
          ...
          <div className="absolute -top-5 -right-2 sm:-top-6 sm:-right-6 bg-[#071A2B]/90 backdrop-blur-md border border-white/15 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-xl shadow-black/50 z-20 flex items-center gap-3">
          ...
          <div className="hidden sm:flex absolute -bottom-5 left-8 bg-[#071A2B]/90 backdrop-blur-md border border-white/15 rounded-xl p-3 shadow-xl z-20 items-center gap-2.5">
          ...
          <div className="hidden sm:flex absolute -bottom-5 right-8 bg-[#071A2B]/90 backdrop-blur-md border border-white/15 rounded-xl p-3 shadow-xl z-20 items-center gap-2.5">
